## 풀이
### 문제에 대한 이해
* 솔직히 말해서 저는 완벽하게 이 문제를 이해하지 못한 상태입니다. 그럼에도 이해한 부분을 최대한 풀이에 남겨 문제를 복기하고 그 과정에서 문제에 대한 이해도 넓히고자 풀이를 작성합니다.
### 자명한 사실들
...
* L을 포함해 전체 문자열은 균등하게 나눴다고 가정하면, L에 시작점이 적아도 포함되어 있다는 사실을 알 수 있습니다. 왜냐면 균등하게 잘린 마디 중 그나마 가장 긴 L에 시작점이 없다면 균등하다는 조건이 무너지기 때문입니다.
### 관점 전환
*
