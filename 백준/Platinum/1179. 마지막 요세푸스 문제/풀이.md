...
**마지막 생존자의 번호를 구하는 게 최종 목표**이기에 굳이 한 사람씩 죽는 경우를 생각할 게 아니라 한 바퀴를 돌았을 경우를 생각해 봅시다.
...
$n<k(1 ≤ K ≤ 90)$ 경우 아래 점화식을 이용합니다.
$$g(n, k)=(g(n-1,\ k)+k) \mod{n} \ \mathrm{if} \ 1 < n < k$$

문제는 $n>k(1 ≤ N ≤ 10^{15})$ 경우 아래 점화식을 이용합니다.
