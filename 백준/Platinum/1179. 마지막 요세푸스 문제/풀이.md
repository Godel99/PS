# 풀이
간단하게 큐를 이용해 요세푸스 문제를 해결할 수 있지만, 이 문제의 경우 입력값의 범위가 매우 높습니다.(1 ≤ N ≤ 10<sup>15</sup>, 1 ≤ K ≤ 90, $\mathcal{O}(n)$ 경우 TLE)
### 수학적 접근
...
문제는 $n$이 클 경우 이를 어떻게 줄일 수 있느냐입니다. 다행히도 한 바퀴를 돌 경우 $n/k$명이 죽는다는 사실을 착안하여 $n-n/k$로 $n$을 줄여갈 수 있습니다. 
### 원위치 조정
