...
### INF 처리
파이썬 코드의 경우는 모든 조합의 경우를 구한 후 다각형 조건을 만족하지 않는 부분을 빼는 방법입니다. 가장 기본이 되는 풀이입니다. 하지만 이보다 좀 더 효율적 방법이 있습니다. 안타깝게도 파이썬에선 INF를 처리하는 방식으론 시간초과(TLE)나서 더 효율적임에도 사용할 수 없습니다.
